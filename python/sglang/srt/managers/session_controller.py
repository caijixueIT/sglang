...
class Session:
    ...
    def create_req(
        ...
        new_req = Req(
            ...
            dualpath_decode_bootstrap_host=req.dualpath_decode_bootstrap_host,
            dualpath_decode_bootstrap_port=req.dualpath_decode_bootstrap_port,
            dualpath_mode=req.dualpath_mode,
            dualpath_selected_path=req.dualpath_selected_path,
