...
class Engine(EngineScoreMixin, EngineBase):
    ...
    def generate(
        ...
        obj = GenerateReqInput(
            ...
            dualpath_decode_bootstrap_host=dualpath_decode_bootstrap_host,
            dualpath_decode_bootstrap_port=dualpath_decode_bootstrap_port,
            dualpath_mode=dualpath_mode,
            dualpath_selected_path=dualpath_selected_path,
