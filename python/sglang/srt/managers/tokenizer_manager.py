    ...
    def _create_tokenized_object(
        ...
        if isinstance(obj, GenerateReqInput):
            ...
            tokenized_obj = TokenizedGenerateReqInput(
                ...
                dualpath_decode_bootstrap_host=obj.dualpath_decode_bootstrap_host,
                dualpath_decode_bootstrap_port=obj.dualpath_decode_bootstrap_port,
                dualpath_mode=obj.dualpath_mode,
                dualpath_selected_path=obj.dualpath_selected_path,
                lora_id=obj.lora_id,
