    ...
    def _convert_to_internal_request(
        ...
        adapted_request = GenerateReqInput(
            **prompt_kwargs,
            ...
            dualpath_decode_bootstrap_host=request.dualpath_decode_bootstrap_host,
            dualpath_decode_bootstrap_port=request.dualpath_decode_bootstrap_port,
            dualpath_mode=request.dualpath_mode,
            dualpath_selected_path=request.dualpath_selected_path,
